...
//
//        composable(ROUTE_PATIENT_DASHBOARD) {PatientDashboard(navController) }
//        composable(ROUTE_DOCTOR_DASHBOARD) { DoctorDashboard(onLogout = ) }
//        composable(ROUTE_ADMIN_DASHBOARD) { AdminDashboard(navController, onLogout = ) }
//
//
//
...
//
//        composable(ROUTE_ADMIN_ADD_DOCTOR) { AdminAddDoctorScreen(navController) }
//
...
import com.example.smartmedicalsystem.ui.theme.Admin.AdminAddDoctorScreen
import com.example.smartmedicalsystem.ui.theme.screens.*
import com.example.smartmedicalsystem.ui.theme.screens.Dashboard.screen.DashboardScreen
import com.example.smartmedicalsystem.ui.theme.screens.screen.Onboarding.screen.OnboardingSlider
...
fun AppNavHost(
    ...
    NavHost(navController = navController, startDestination = startDestination) {
        ...
        composable(ROUTE_PATIENT_DASHBOARD) {
            PatientDashboard(
                navController = navController,
        ...
        composable(ROUTE_DOCTOR_DASHBOARD) {
            DoctorDashboard(
                onLogout = { navController.logout() }
            )
        }

...
//                            }
//
//                            // 2. Email validation (MUST come before signup)
...
//    var email by remember { mutableStateOf("") }
//    var gender by remember { mutableStateOf("") }
//    var selectedRole by remember { mutableStateOf("patient") } // Default role
//    var password by remember { mutableStateOf("") }
//    var confirmPassword by remember { mutableStateOf("") }
//    var passwordVisible by remember { mutableStateOf(false) }
//    var confirmPasswordVisible by remember { mutableStateOf(false) }
...
//
//                    // ROLE SELECTION
//                    Text("Register as:", fontWeight = FontWeight.Bold)
//                    Row(verticalAlignment = Alignment.CenterVertically) {
//                        RadioButton(
...
//                                confirmpassword = confirmPassword,
//                                gender = gender,
//                                role = selectedRole, // Sending the selected role to ViewModel
//                                navController = navController,
//                                context = context
//                            )
//                        },
...
//        ) {
//            Spacer(modifier = Modifier.height(30.dp))
//            Text("Create Patient Account", fontSize = 28.sp, fontWeight = FontWeight.Bold, color = Color(0xFF0D47A1))
//            Spacer(modifier = Modifier.height(20.dp))
//
//            Card(
//                modifier = Modifier.fillMaxWidth(),
...
//                        OutlinedTextField(value = lastName, onValueChange = { lastName = it }, label = { Text("Last Name") }, modifier = Modifier.weight(1f), shape = RoundedCornerShape(12.dp))
//                    }
...
//                    Row {
//                        RadioButton(selected = gender == "Male", onClick = { gender = "Male" })
//                        Text("Male", modifier = Modifier.clickable { gender = "Male" }.align(Alignment.CenterVertically))
//                        Spacer(modifier = Modifier.width(16.dp))
//                        RadioButton(selected = gender == "Female", onClick = { gender = "Female" })
//                        Text("Female", modifier = Modifier.clickable { gender = "Female" }.align(Alignment.CenterVertically))
//                    }
//
//                    Button(
//                        onClick = {
//                            authViewModel.signup(firstName, lastName, email, password, confirmPassword, gender, "patient", navController, context)
//                        },
